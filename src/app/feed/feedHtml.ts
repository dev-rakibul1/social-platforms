					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							<li class="nav-item _header_nav_item">
								<a class="nav-link _header_nav_link_active _header_nav_link" aria-current="page" href="/feed">
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<ul class="_mobile_navigation_bottom_list">
									<li class="_mobile_navigation_bottom_item">
										<a href="/feed" class="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="_layout_middle_wrap">
								<div class="_layout_middle_inner">
									...
									<!--For Mobile End-->
									<div class="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16 _sp_composer">
										<div class="_feed_inner_text_area_box _sp_composer_box">
											<div class="_feed_inner_text_area_box_image">
												<img src="assets/images/txt_img.png" alt="Image" class="_txt_img">
											</div>
											<div class="_feed_inner_text_area_box_form _sp_composer_form">
												<div class="_sp_composer_heading">
													<span class="_sp_composer_title">Create a post</span>
													<span class="_sp_composer_hint">Share a thought and add one photo with live preview.</span>
												</div>
												<textarea class="form-control _textarea _sp_composer_textarea" placeholder="Write something ..." id="floatingTextarea"></textarea>
												<div id="_composer_preview_card" class="_sp_composer_preview d-none">
													<div class="_sp_composer_preview_media">
														<img id="_composer_preview_image" src="" alt="Selected post image" class="_sp_composer_preview_image">
													</div>
													<div class="_sp_composer_preview_body">
														<div class="_sp_composer_preview_meta">
															<span class="_sp_composer_preview_label">Selected image</span>
															<span id="_composer_preview_name" class="_sp_composer_preview_name"></span>
														</div>
														<div class="_sp_composer_preview_actions">
															<button type="button" class="_sp_composer_secondary_btn" id="_composer_replace_btn">Replace</button>
															<button type="button" class="_sp_composer_secondary_btn _sp_composer_secondary_btn_danger" id="_composer_remove_btn">Remove</button>
														</div>
													</div>
												</div>
											</div>
										</div>
										<div class="_feed_inner_text_area_bottom _sp_composer_toolbar">
											<div class="_feed_inner_text_area_item _sp_composer_actions">
												<div class="_feed_inner_text_area_bottom_photo _feed_common _sp_composer_action">
												...
												<div class="_feed_inner_text_area_bottom_video _feed_common _sp_composer_action _sp_composer_action_static">
													<button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Video option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img">   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24"><path fill="#666" d="M11.485 4.5c2.213 0 3.753 1.534 3.917 3.784l2.418-1.082c1.047-.468 2.188.327 2.271 1.533l.005.141v6.64c0 1.237-1.103 2.093-2.155 1.72l-.121-.047-2.418-1.083c-.164 2.25-1.708 3.785-3.917 3.785H5.76c-2.343 0-3.932-1.72-3.932-4.188V8.688c0-2.47 1.589-4.188 3.932-4.188h5.726zm0 1.5H5.76C4.169 6 3.197 7.05 3.197 8.688v7.015c0 1.636.972 2.688 2.562 2.688h5.726c1.586 0 2.562-1.054 2.562-2.688v-.686-6.329c0-1.636-.973-2.688-2.562-2.688zM18.4 8.57l-.062.02-2.921 1.306v4.596l2.921 1.307c.165.073.343-.036.38-.215l.008-.07V8.876c0-.195-.16-.334-.326-.305z"/></svg></span>Video</button>
												</div>
												<div class="_feed_inner_text_area_bottom_event _feed_common _sp_composer_action _sp_composer_action_static">
													<button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Event option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img">  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24"><path fill="#666" d="M14.371 2c.32 0 .585.262.627.603l.005.095v.788c2.598.195 4.188 2.033 4.18 5v8.488c0 3.145-1.786 5.026-4.656 5.026H7.395C4.53 22 2.74 20.087 2.74 16.904V8.486c0-2.966 1.596-4.804 4.187-5v-.788c0-.386.283-.698.633-.698.32 0 .584.262.626.603l.006.095v.771h5.546v-.771c0-.386.284-.698.633-.698zm3.546 8.283H4.004l.001 6.621c0 2.325 1.137 3.616 3.183 3.697l.207.004h7.132c2.184 0 3.39-1.271 3.39-3.63v-6.692zm-3.202 5.853c.349 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-3.742 0c.35 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.238-.645.546-.692l.094-.006zm-3.75 0c.35 0 .633.312.633.698 0 .353-.238.645-.547.691l-.093.006c-.35 0-.633-.312-.633-.697 0-.354.238-.645.547-.692l.094-.006zm7.492-3.615c.349 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.237-.645.546-.691l.094-.006zm-3.742 0c.35 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.238-.645.546-.691l.094-.006zm-3.75 0c.35 0 .633.312.633.697 0 .354-.238.645-.547.692l-.093.006c-.35 0-.633-.312-.633-.698 0-.353.238-.645.547-.691l.094-.006zm6.515-7.657H8.192v.895c0 .385-.283.698-.633.698-.32 0-.584-.263-.626-.603l-.006-.095v-.874c-1.886.173-2.922 1.422-2.922 3.6v.402h13.912v-.403c.007-2.181-1.024-3.427-2.914-3.599v.874c0 .385-.283.698-.632.698-.32 0-.585-.263-.627-.603l-.005-.095v-.895z"/></svg></span>Event</button>
												</div>
												<div class="_feed_inner_text_area_bottom_article _feed_common _sp_composer_action _sp_composer_action_static">
													<button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Article option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none" viewBox="0 0 18 20"><path fill="#666" d="M12.49 0c2.92 0 4.665 1.92 4.693 5.132v9.659c0 3.257-1.75 5.209-4.693 5.209H5.434c-.377 0-.734-.032-1.07-.095l-.2-.041C2 19.371.74 17.555.74 14.791V5.209c0-.334.019-.654.055-.96C1.114 1.564 2.799 0 5.434 0h7.056zm-.008 1.457H5.434c-2.244 0-3.381 1.263-3.381 3.752v9.582c0 2.489 1.137 3.752 3.38 3.752h7.049c2.242 0 3.372-1.263 3.372-3.752V5.209c0-2.489-1.13-3.752-3.372-3.752zm-.239 12.053c.36 0 .652.324.652.724 0 .4-.292.724-.652.724H5.656c-.36 0-.652-.324-.652-.724 0-.4.293-.724.652-.724h6.587zm0-4.239a.643.643 0 01.632.339.806.806 0 010 .78.643.643 0 01-.632.339H5.656c-.334-.042-.587-.355-.587-.729s.253-.688.587-.729h6.587zM8.17 5.042c.335.041.588.355.588.729 0 .373-.253.687-.588.728H5.665c-.336-.041-.589-.355-.589-.728 0-.374.253-.688.589-.729H8.17z"/></svg></span>Article</button>
												</div>
												<div class="_sp_composer_audience_slot" data-composer-audience-slot="1"></div>
											</div>
											<div class="_feed_inner_text_area_btn _sp_composer_submit">
										...
										<div class="_feed_inner_text_area_bottom_mobile">
											<div class="_feed_inner_text_mobile _sp_composer_toolbar _sp_composer_toolbar_mobile">
												<div class="_feed_inner_text_area_item _sp_composer_actions">
													<div class="_feed_inner_text_area_bottom_photo _feed_common _sp_composer_action">
														<button type="button" class="_feed_inner_text_area_bottom_photo_link">
															<span class="_feed_inner_text_area_bottom_photo_iamge _mar_img">
													...
													<div class="_feed_inner_text_area_bottom_video _feed_common _sp_composer_action _sp_composer_action_static"><button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Video option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img">   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24"><path fill="#666" d="M11.485 4.5c2.213 0 3.753 1.534 3.917 3.784l2.418-1.082c1.047-.468 2.188.327 2.271 1.533l.005.141v6.64c0 1.237-1.103 2.093-2.155 1.72l-.121-.047-2.418-1.083c-.164 2.25-1.708 3.785-3.917 3.785H5.76c-2.343 0-3.932-1.72-3.932-4.188V8.688c0-2.47 1.589-4.188 3.932-4.188h5.726zm0 1.5H5.76C4.169 6 3.197 7.05 3.197 8.688v7.015c0 1.636.972 2.688 2.562 2.688h5.726c1.586 0 2.562-1.054 2.562-2.688v-.686-6.329c0-1.636-.973-2.688-2.562-2.688zM18.4 8.57l-.062.02-2.921 1.306v4.596l2.921 1.307c.165.073.343-.036.38-.215l.008-.07V8.876c0-.195-.16-.334-.326-.305z"/></svg></span>Video</button></div>
													<div class="_feed_inner_text_area_bottom_event _feed_common _sp_composer_action _sp_composer_action_static"><button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Event option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img">  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24"><path fill="#666" d="M14.371 2c.32 0 .585.262.627.603l.005.095v.788c2.598.195 4.188 2.033 4.18 5v8.488c0 3.145-1.786 5.026-4.656 5.026H7.395C4.53 22 2.74 20.087 2.74 16.904V8.486c0-2.966 1.596-4.804 4.187-5v-.788c0-.386.283-.698.633-.698.32 0 .584.262.626.603l.006.095v.771h5.546v-.771c0-.386.284-.698.633-.698zm3.546 8.283H4.004l.001 6.621c0 2.325 1.137 3.616 3.183 3.697l.207.004h7.132c2.184 0 3.39-1.271 3.39-3.63v-6.692zm-3.202 5.853c.349 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-3.742 0c.35 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.238-.645.546-.692l.094-.006zm-3.75 0c.35 0 .633.312.633.698 0 .353-.238.645-.547.691l-.093.006c-.35 0-.633-.312-.633-.697 0-.354.238-.645.547-.692l.094-.006zm7.492-3.615c.349 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.237-.645.546-.691l.094-.006zm-3.742 0c.35 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.238-.645.546-.691l.094-.006zm-3.75 0c.35 0 .633.312.633.697 0 .354-.238.645-.547.692l-.093.006c-.35 0-.633-.312-.633-.698 0-.353.238-.645.547-.691l.094-.006zm6.515-7.657H8.192v.895c0 .385-.283.698-.633.698-.32 0-.584-.263-.626-.603l-.006-.095v-.874c-1.886.173-2.922 1.422-2.922 3.6v.402h13.912v-.403c.007-2.181-1.024-3.427-2.914-3.599v.874c0 .385-.283.698-.632.698-.32 0-.585-.263-.627-.603l-.005-.095v-.895z"/></svg></span>Event</button></div>
													<div class="_feed_inner_text_area_bottom_article _feed_common _sp_composer_action _sp_composer_action_static"><button type="button" class="_feed_inner_text_area_bottom_photo_link" aria-label="Article option coming soon"><span class="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none" viewBox="0 0 18 20"><path fill="#666" d="M12.49 0c2.92 0 4.665 1.92 4.693 5.132v9.659c0 3.257-1.75 5.209-4.693 5.209H5.434c-.377 0-.734-.032-1.07-.095l-.2-.041C2 19.371.74 17.555.74 14.791V5.209c0-.334.019-.654.055-.96C1.114 1.564 2.799 0 5.434 0h7.056zm-.008 1.457H5.434c-2.244 0-3.381 1.263-3.381 3.752v9.582c0 2.489 1.137 3.752 3.38 3.752h7.049c2.242 0 3.372-1.263 3.372-3.752V5.209c0-2.489-1.13-3.752-3.372-3.752zm-.239 12.053c.36 0 .652.324.652.724 0 .4-.292.724-.652.724H5.656c-.36 0-.652-.324-.652-.724 0-.4.293-.724.652-.724h6.587zm0-4.239a.643.643 0 01.632.339.806.806 0 010 .78.643.643 0 01-.632.339H5.656c-.334-.042-.587-.355-.587-.729s.253-.688.587-.729h6.587zM8.17 5.042c.335.041.588.355.588.729 0 .373-.253.687-.588.728H5.665c-.336-.041-.589-.355-.589-.728 0-.374.253-.688.589-.729H8.17z"/></svg></span>Article</button></div>
													<div class="_sp_composer_audience_slot" data-composer-audience-slot="1"></div>
												</div>
												<div class="_feed_inner_text_area_btn _sp_composer_submit">
													<button type="button" class="_feed_inner_text_area_btn_link">
														<svg class="_mar_img" xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="none" viewBox="0 0 14 13"><path fill="#fff" fill-rule="evenodd" d="M6.37 7.879l2.438 3.955a.335.335 0 00.34.162c.068-.01.23-.05.289-.247l3.049-10.297a.348.348 0 00-.09-.35.341.341 0 00-.34-.088L1.75 4.03a.34.34 0 00-.247.289.343.343 0 00.16.347L5.666 7.17 9.2 3.597a.5.5 0 01.712.703L6.37 7.88zM9.097 13c-.464 0-.89-.236-1.14-.641L5.372 8.165l-4.237-2.65a1.336 1.336 0 01-.622-1.331c.074-.536.441-.96.957-1.112L11.774.054a1.347 1.347 0 011.67 1.682l-3.05 10.296A1.332 1.332 0 019.098 13z" clip-rule="evenodd" /></svg>
														<span>Post</span>
													</button>
												</div>
											</div>
									...
									<div class="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16" style="display:none">
